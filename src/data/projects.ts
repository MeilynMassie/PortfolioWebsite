...
export const allProjects: Project[] = [
  ...
  },
  {
    ...
    date: "April 2026",
    title: "Trivia UI",
    peekStack: "Angular · TypeScript · Tailwind CSS",
    ...
    techStack: ["Angular", "TypeScript", "Tailwind CSS", "Trivia API", "Vercel"],
    status: "In progress",
    statusColor: "bg-amber-500",
  ...
  },
  {
    ...
    year: 2025,
    date: "January 2025",
    title: "JavaScript Puzzle Game",
    peekStack: "JavaScript · HTML · CSS",
    body: "A maze like game that operates like a blast from the past, built with vanilla JavaScript, HTML, and CSS.",
    github: "https://github.com/MeilynMassie/Interactive_Website",
  },
  {
    id: "07",
    year: 2023,
    ...
    peekStack: "Python",
    body: "A terminal inline choose your own adventure game with images built with Python.",
    github: "https://github.com/MeilynMassie/Python_Adventure_Game",
  },
  {
    id: "08",
    year: 2023,
    ...
    title: "Solar Tracker",
    peekStack: "C++ · Arduino",
    body: "A solar tracking application built with C++ to run on an Arduino. The robot automatically adjusts its position based on the percentage of shade detected.",
    github: "https://github.com/MeilynMassie/SolarTracker",
  },
